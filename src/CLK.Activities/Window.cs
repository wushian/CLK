...
namespace CLK.Activities
{
    public partial class Window : System.Windows.Window, INotifyPropertyChanged
    {
        ...
        protected virtual void Initialize()
        {
            ...
            if (this.DataContext is WindowModel == false) throw new InvalidOperationException("this.DataContext=" + this.DataContext.GetType().FullName);
            if (_model != null) throw new InvalidOperationException("_model!=null");

            // Model
            _model = this.DataContext as WindowModel;
        }
