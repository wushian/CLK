...
{
    internal class CompositeLoggerFactory : LoggerFactory
    {
        // Fields
        ...
        // Constructors
        public CompositeLoggerFactory(IEnumerable<LoggerProvider> loggerProviderList)
        {
            #region Contracts
        ...
        public Logger<TCategory> Create<TCategory>()
        {
            ...
            lock(_syncRoot)
            {
                ...
                if (_loggerDictionary.ContainsKey(typeof(TCategory)) == false)
                {
                    ...
                    // Add
                    _loggerDictionary.Add(typeof(TCategory), new CompositeLogger<TCategory>(loggerList));
                }
